...
test("repair introduction and accordion follow the archive body typography", () => {
  ...
  assert.match(repairHtml, /repair-20260925-01\.css\?v=20260925-08/);
  ...
  assert.match(repairDetailCss, /\.repair-process-list span\s*\{[^}]*color:\s*#111 !important;[^}]*font-family:\s*var\(--font-kor-body\) !important;[^}]*font-size:\s*16px !important;[^}]*font-weight:\s*500 !important;[^}]*line-height:\s*var\(--type-body-leading, 1\.55\) !important;/);
});
