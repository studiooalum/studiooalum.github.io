...
function resetContentForm(seed = {}) {
  ...
  dom.contentForm.elements.allowSharedBookings.checked = bookingConfig.allowSharedBookings;
...
function collectWorkshopPayload(statusOverride) {
  ...
  const bookingConfig = {
    ...
    maxBookingMonths: 6,
    allowSharedBookings: form.elements.allowSharedBookings.checked === true,
    attendeePrices,
  };
